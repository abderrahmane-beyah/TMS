...
const navItems: NavItem[] = [
  {
    ...
    roles: ['Dispatcheur', 'Administrateur'],
  },
  {
    to: '/commandes',
    label: 'Commandes',
    ...
    roles: ['Dispatcheur', 'Expediteur', 'Administrateur'],
  },
  {
    to: '/tournees',
    label: 'Tournées',
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-64 flex-col bg-gray-900 text-white transition-transform lg:translate-x-0 ${
      ...
      >
        ...
        <div className="border-t border-gray-800 p-4">
          <div className="mb-3 text-xs text-gray-400">
            Connecté en tant que <span className="font-medium text-gray-200">{role}</span>
          </div>
          <button
